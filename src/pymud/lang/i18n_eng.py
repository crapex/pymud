TRANSLATION = {
    "text": {
        ...
        "msg_socks5_unknown_state": "Unknown SOCKS5 state: {0}",
        "msg_socks5_transport_closed_before_mud": "SOCKS5 connection closed before entering MUD protocol phase",
        "msg_socks5_transport_not_ready": "SOCKS5 connection is not established",
        "msg_socks5_handshake_failed": "SOCKS5 proxy handshake failed: {0}",
        "msg_socks5_handshake_timeout": "SOCKS5 handshake timeout ({0}s): state={1}",
