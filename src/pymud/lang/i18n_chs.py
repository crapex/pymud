TRANSLATION = {
    "text": {
        ...
        "msg_no_specified_session": "不存在名称为{0}的会话。",
        ...
        "msg_socks5_unknown_state": "未知的SOCKS5状态: {0}",
        "msg_socks5_transport_closed_before_mud": "SOCKS5连接已关闭，无法进入MUD协议阶段",
        "msg_socks5_transport_not_ready": "SOCKS5连接未建立",
        "msg_socks5_handshake_failed": "SOCKS5代理握手失败: {0}",
        "msg_socks5_handshake_timeout": "SOCKS5握手超时({0}s): state={1}",
